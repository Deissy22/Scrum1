...
<html lang="es">
    ...
    <body>
        ...
        <section class="section">
            <div class="container">
                <h1 class="title is-3 has-text-centered mb-5">Agregar Servicio</h1>
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/ServAdminController">
                        ...
                        <div class="columns">
                            <div class="column">
                                ...
                                <input class="input" type="text" name="nombre_servicio" required>
                            </div>
                            <div class="column">
                        ...
                        <div class="columns">
                            <div class="column">
                                ...
                                <textarea class="textarea input has-text-light" name="descripcion"
                                          placeholder="Ej: Lote nuevo, proveedor, etc."></textarea>
                            </div>
                        </div>
                        <div class="field mt-5">
                            <button class="button is-danger is-fullwidth">
                                <i class="fa-solid fa-pen-to-square"></i>&nbsp; Agregar Servicio
                            </button>
