...
<body>
    ...
    <section class="section">
        <div class="container">
            <h1 class="title is-2 has-text-centered">Bienvenido Vendedor</h1>
            ...
            <div class="columns is-multiline mt-5">
                <div class="column">
                    <div class="box has-text-centered">
                        ...
                        <a href="${pageContext.request.contextPath}/vistas/errores/404.jsp" class="button is-link mt-3">Ver Inventario</a><!--redireccionar a inventario-->
                    </div>
                </div>
                ...
                <div class="column is-half">
                    <div class="box has-text-centered">
                        ...
                        <a href="${pageContext.request.contextPath}/ProductoController?accion=listar" class="button is-link mt-3">Ver Productos</a><!--redireccionar a productos-->
                    </div>
                </div>
                ...
                <div class="column is-half">
                    <div class="box has-text-centered">
                        ...
                        <a href="${pageContext.request.contextPath}/vistas/errores/404.jsp" class="button is-link mt-3">Ver Ventas</a><!--redireccionar a ventas-->
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="box has-text-centered">
                        ...
                        <a href="${pageContext.request.contextPath}/VendedorController?accion=listarClientes" class="button is-link mt-3">Ver Clientes</a>
                    </div>
                </div>
