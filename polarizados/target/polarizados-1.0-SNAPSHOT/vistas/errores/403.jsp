...
<body>
  ...
  <section class="section has-text-centered">
    <div class="container">
      ...
      <h2 class="title is-2 has-text-white">403</h2>
      <p class="subtitle is-4 has-text-white">Acceso denegado</p>
      <p class="has-text-white mb-5">No tienes permisos para acceder a esta pagina.</p>
