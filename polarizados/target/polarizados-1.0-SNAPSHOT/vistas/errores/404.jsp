...
<body>
  ...
  <section class="section has-text-centered">
    <div class="container">
      ...
      <h2 class="title is-2 has-text-white">404</h2>
      <p class="subtitle is-4 has-text-white">Oops... Página no encontrada</p>
      <p class="has-text-white mb-5">La ruta que estás buscando no existe o ha sido movida.</p>
