...
<html lang="es">
    ...
    <body>
        ...
        <section class="section">
            <div class="container">
                <h1 class="title is-2 has-text-centered">Bienvenido Tecnico</h1>
                ...
                <div class="column">
                    <div class="box has-text-centered">
                        ...
                        <a href="${pageContext.request.contextPath}/vistas/errores/404.jsp" class="button is-link mt-3">Ver Servicios</a><!--redireccionar a servicios-->
                    </div>
                </div>
