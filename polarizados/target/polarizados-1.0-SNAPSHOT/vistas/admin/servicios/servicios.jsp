...
<html lang="es">
    ...
    <head>
        ...
        <title>Servicios - JJ Polarizados</title>
            ...
            <div class="container">
                <div class="level mb-5">
                    <div class="level-left">
                        <h1 class="title is-3">Servicios</h1>
                    </div>
                    <div class="level-right">
                        <a href="${pageContext.request.contextPath}/ServAdminController?accion=nuevo"class="button">
                            <i class="fas fa-plus-circle"></i>&nbsp; Registrar un Servicio
                        </a>
                        <a href="${pageContext.request.contextPath}/vistas/admin/servicios/productoServicio.jsp" class="button">
                            <i class="fa-solid fa-recycle"></i>&nbsp; Productos Utilizados
                        </a>
                    </div>
                </div>
                <!-- BÚSQUEDA -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="buttons are-small">
                                            <a href="${pageContext.request.contextPath}/ServAdminController?accion=editar&id_servicio=${servicio.idServicio}" class="button is-light">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <form method="GET" action="${pageContext.request.contextPath}/ServAdminController" style="display:inline;">
