        ...
        <nav class="navbar is-fixed-top has-background-black" role="navigation" aria-label="main navigation">
            ...
            <div id="mainNavbar" class="navbar-menu is-active">
                <div class="navbar-end">
                    ...
                    <a class="navbar-item has-text-white" href="${pageContext.request.contextPath}/vistas/errores/404.jsp"><!--cambiar redireccion-->
            ...
            <div class="container">
                <div class="level mb-5">
                    ...
                    <div class="level-right">
                        <a href="${pageContext.request.contextPath}/AdminController?accion=nuevoCliente" class="button">
